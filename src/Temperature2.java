...
public class Temperature2
{
	...
	public static double calculate_air_conduction_heat_rate(double temperature, double surface_area, double thickness, double humidity)
	{
		...
		double wetbulb_temperature = 30;//calculate_wetbulb_temperature(temperature, humidity);
	...
	{	
		...
		double air_velocity2 = air_velocity + 0.0000000000001;
		double surface_area2 = surface_area + 0.0000000000001;
		double intensity2 = intensity + 0.0000000000001;
		...
		String information15 = String.format("%30s  %.15s %s", "Air Conduction Heat Rate:", new BigDecimal(air_conduction_heat_rate), "(W)");
		System.out.println(information15);
		
		String information16 = String.format("%30s  %.15s %s", "Skin Conduction Heat Rate:", new BigDecimal(skin_conduction_heat_rate), "(W)");
		System.out.println(information16);
		
		String information17 = String.format("%30s  %.15s %s", "Conduction Heat Rate:", new BigDecimal(conduction_heat_rate), "(W)");
		System.out.println(information17);
		
		String information18 = String.format("%30s  %.15s %s", "Heat Rate:", new BigDecimal(heat_rate), "(W)");
		System.out.println(information18);
		
		String information19 = String.format("%30s  %.15s %s", "Wetbulb Temperature:", new BigDecimal(wetbulb_temperature), "(K)");
