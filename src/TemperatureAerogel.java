...
public class TemperatureAerogel
{
	...
	public static void main(String args[])
	{
		System.out.println("\nIndoor");
		set_indoor();
		print_data(ambient_temperature, atmospheric_pressure, humidity, air_velocity, surface_area, albedo, absorption_thickness, nonabsorption_thickness, altitude, absorption_area_density, nonabsorption_area_density, hygroscopy, skin_conduction_heat_rate);
	...
	public static double calculate_air_conduction_heat_rate(double ambient_temperature, double water_temperature, double atmospheric_pressure, double air_velocity, double surface_area, double absorption_thickness, double humidity)
	{
	...
	public static double calculate_surface_temperature(double surface_area, double albedo, double altitude)
	{
		...
		double surface_temperature =
				radiation_heat_rate = 10;
				
		return surface_temperature;
	}
	
	public static double calculate_insulated_conduction_heat_rate(double ambient_temperature, double water_temperature, double surface_area, double nonabsorption_thickness)
	{
		double insulator_thermal_conductivity = 0.016;//W/mK fiber-reinforced plastic can have similar thermal conductivity to water
	...
	public static double calculate_conduction_heat_rate(double ambient_temperature, double water_temperature, double atmospheric_pressure, double air_velocity, double surface_area, double nonabsorption_thickness, double humidity, double skin_conduction_heat_rate)
	{	
		double insulated_conduction_heat_rate = 
				calculate_insulated_conduction_heat_rate(ambient_temperature, water_temperature, surface_area, nonabsorption_thickness);
	...
	public static double calculate_heat_rate(double ambient_temperature, double water_temperature, double atmospheric_pressure, double humidity, double air_velocity, double surface_area, double albedo, double absorption_thickness, double nonabsorption_thickness, double altitude, double skin_conduction_heat_rate)
	{	
		...
		double conduction_heat_rate =
				calculate_conduction_heat_rate(ambient_temperature, water_temperature, atmospheric_pressure, air_velocity, surface_area, nonabsorption_thickness, humidity, skin_conduction_heat_rate);
	...
	public static double calculate_temperature_rate(double ambient_temperature, double water_temperature, double atmospheric_pressure, double humidity, double air_velocity, double surface_area, double albedo, double absorbtion_thickness, double nonabsorbtion_thickness, double altitude, double absorption_area_density, double hygroscopy, double skin_conduction_heat_rate)
	{
		...
		double total_heat_rate = 
				calculate_heat_rate(ambient_temperature, water_temperature, atmospheric_pressure, humidity, air_velocity, surface_area, albedo, absorbtion_thickness, nonabsorbtion_thickness, altitude, skin_conduction_heat_rate);
	...
	public static double calculate_water_temperature(double ambient_temperature, double atmospheric_pressure, double humidity, double air_velocity, double surface_area, double albedo, double absorbtion_thickness, double nonabsorbtion_thickness, double altitude, double skin_conduction_heat_rate)
	{
		double wetbulb_temperature = calculate_wetbulb_temperature(ambient_temperature, humidity);
		
		double water_temperature = wetbulb_temperature;

	    while (0 < calculate_heat_rate(ambient_temperature, water_temperature, atmospheric_pressure, humidity, air_velocity, surface_area, albedo, absorbtion_thickness, nonabsorbtion_thickness, altitude, skin_conduction_heat_rate))
	    {
	...
	public static void print_data(double ambient_temperature, double atmospheric_pressure, double humidity, double air_velocity, double surface_area, double albedo, double absorption_thickness, double nonabsorption_thickness, double altitude, double absorption_area_density, double nonabsorption_area_density, double hygroscopy, double skin_conduction_heat_rate)
	{	
		...
		String information1 = String.format("%35s  %.15s %s", "Ambient Temperature:", new BigDecimal(ambient_temperature2 - 273.16), "(¡ÆC)");
		System.out.println(information1);
		
		String information2 = String.format("%35s  %.15s %s", "Atmospheric Pressure:", new BigDecimal(atmospheric_pressure2), "(kPa)");
		...
		String information211 = String.format("%35s  %.15s %s", "Direct Insolation:", new BigDecimal(direct_insolation2), "(W)");
		System.out.println(information211);
		
		String information212 = String.format("%35s  %.15s %s", "Direct Irradiance:", new BigDecimal(direct_irradiance2), "(W)");
		...
		String information8 = String.format("%35s  %.15s %s", "Absorbtion Thickness:", new BigDecimal(absorption_thickness2 * 1000), "(mm)");
		System.out.println(information8);
		
		String information118 = String.format("%35s  %.15s %s", "Nonabsorbtion Thickness:", new BigDecimal(nonabsorption_thickness2 * 1000), "(mm)");
		System.out.println(information118);
		
		String information9 = String.format("%35s  %.15s %s", "Absorption Area Density:", new BigDecimal(absorption_area_density2 * 1000), "(g/m^2)");
		System.out.println(information9);
		
		String information99 = String.format("%35s  %.15s %s", "Non Absorption Area Density:", new BigDecimal(nonabsorption_area_density2 * 1000), "(g/m^2)");
		...
		String information111 = String.format("%35s  %.15s %s", "Water Volume:", new BigDecimal(water_volume2 * 1000.001), "(ml)");
		System.out.println(information111);
		
		String information112 = String.format("%35s  %.15s %s", "Cloth Weight:", new BigDecimal(cloth_weight2 * 1000), "(g)");
		System.out.println(information112);
		
		String information113 = String.format("%35s  %.15s %s", "Total Weight:", new BigDecimal(total_weight2 * 1000), "(g)");
		...
		double water_temperature = calculate_water_temperature(ambient_temperature, atmospheric_pressure, humidity, air_velocity, surface_area, albedo, absorption_thickness, nonabsorption_thickness, altitude, skin_conduction_heat_rate);
		...
		double insulated_conduction_heat_rate = calculate_insulated_conduction_heat_rate(ambient_temperature, water_temperature, surface_area, nonabsorption_thickness);
		double skin_conduction_heat_rate2 = skin_conduction_heat_rate+0.001;
		double conduction_heat_rate = calculate_conduction_heat_rate(ambient_temperature, water_temperature, atmospheric_pressure, air_velocity, surface_area, nonabsorption_thickness, humidity, skin_conduction_heat_rate);
		double heat_rate = calculate_heat_rate(ambient_temperature, water_temperature, atmospheric_pressure, humidity, air_velocity, surface_area, albedo, absorption_thickness, nonabsorption_thickness, altitude, skin_conduction_heat_rate);
		double wetbulb_temperature = calculate_wetbulb_temperature(ambient_temperature, humidity);
		int duration = (int)calculate_duration(surface_area, absorption_area_density, hygroscopy, evaporation_rate);
		
		System.out.println("\n.....................................................................\n\n#Data\n");
		
		String information12 = String.format("%35s  %.15s %s", "Evaporation Rate:", new BigDecimal(evaporation_rate * 1000), "(g/s)");
		System.out.println(information12);
		
		String information23 = String.format("%35s  %.15s %s", "Evaporation Rate:", new BigDecimal(evaporation_rate * 1000 * 60 * 60), "(g/hr)");
		System.out.println(information23);
		
		String information20 = String.format("%35s  %.15s %s", "Wetbulb Temperature:", new BigDecimal(wetbulb_temperature - 273.16), "(¡ÆC)");
		System.out.println(information20);
		
		String information21 = String.format("%35s  %.15s %s", "Water Temperature:", new BigDecimal(water_temperature - 273.16), "(¡ÆC)");
		System.out.println(information21);
		
		String information13 = String.format("%35s  %.15s %s", "Evaporation Heat Rate:", new BigDecimal(evaporation_heat_rate), "(W)");
		System.out.println(information13);
		
		String information14 = String.format("%35s  %.15s %s", "Radiation Heat Rate:", new BigDecimal(radiation_heat_rate), "(W)");
		System.out.println(information14);
		
		String information17 = String.format("%35s  %.15s %s", "Skin Conduction Heat Rate:", new BigDecimal(skin_conduction_heat_rate), "(W)");
		System.out.println(information17);
		
		String information15 = String.format("%35s  %.15s %s", "Insulated Conduction Heat Rate:", new BigDecimal(insulated_conduction_heat_rate), "(W)");
		System.out.println(information15);
		
		String information18 = String.format("%35s  %.15s %s", "Conduction Heat Rate:", new BigDecimal(conduction_heat_rate), "(W)");
		...
		String information22 = String.format("%35s  %.15s %s", "Duration:", duration/60/60+":"+duration/60%60+":"+duration%60%60, "");
