...
public class TemperatureAerogel5
{
	//Climate Setting
	...
	//Cloth Setting
	static double surface_area = 0.8; //Large cotton T-shirt * 2 m^2xstatic double absorption_area_density = 0.080; //kg/m^2
	static double nonabsorption_thickness = 0.004; //m thickness of outer layer 0.015
	static double absorption_thickness = 0.0014; //m thickness of water. mine was 0.0011, jacket is 0.001
	static double insulator_thermal_conductivity = 0.014;
	static double breathability = 0.8;//.% lower breathability slightly increases duration
	...
	static double absorption_area_density = 0.080 * absorption_thickness / 0.0011;
	...
	static double skin_conduction_heat_rate = 100 * 0.40;//average men powers 100W heat percentage: http://files.forensicmed.webnode.com/200000116-a70bfa8060/lund_and_browder_chart.jpg //heat produced: https://en.wikipedia.org/wiki/Basal_metabolic_rate //body heat loss is proportional to surface area: http://www.livescience.com/34411-body-heat-loss-head.html
	...
	public static double calculate_water_temperature(double ambient_temperature, double atmospheric_pressure, double humidity, double air_velocity, double surface_area, double breathability, double albedo, double emissivity_coefficient, double absorbtion_thickness, double nonabsorbtion_thickness, double altitude, double skin_conduction_heat_rate)
	{
	    ...
	    while (insulated_heat_rate > -skin_conduction_heat_rate - evaporation_heat_rate)
	    {
	    	...
	    	surface_temperature = calculate_surface_temperature(ambient_temperature, water_temperature, atmospheric_pressure, humidity, air_velocity, surface_area, albedo, emissivity_coefficient, altitude, breathability, skin_conduction_heat_rate);
	...
	{	
		...
		String information35 = String.format("%35s  %.15s %s", "Surface Temperature:", new BigDecimal(surface_temperature - 273.16), "(¡ÆC)");
