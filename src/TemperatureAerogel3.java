...
public class TemperatureAerogel3
{
	...
	{
		double water_temperature = -10.0;
		
		double surface_temperature = -10.0;

		double wetbulb_temperature = calculate_wetbulb_temperature(ambient_temperature, humidity);
		
		water_temperature = wetbulb_temperature;
	...
	{	
		...
		String information11 = String.format("%35s  %.15s %s", "Ambient Temperature:", new BigDecimal(ambient_temperature2 - 273.16), "(¡ÆC)");
		...
		String information15 = String.format("%35s  %.15s %s", "Altitude:", new BigDecimal(altitude2), "(¡Æ)");
		...
		String information31 = String.format("%35s  %.15s %s", "Air Wetbulb Temperature:", new BigDecimal(air_wetbulb_temperature - 273.16), "(¡ÆC)");
		System.out.println(information31);
		
		String information32 = String.format("%35s  %.15s %s", "Water Wetbulb Temperature:", new BigDecimal(water_wetbulb_temperature - 273.16), "(¡ÆC)");
		System.out.println(information32);
		
		String information33 = String.format("%35s  %.15s %s", "Ambient Temperature:", new BigDecimal(ambient_temperature2 - 273.16), "(¡ÆC)");
		System.out.println(information33);
		
		String information34 = String.format("%35s  %.15s %s", "Water Temperature:", new BigDecimal(water_temperature - 273.16), "(¡ÆC)");
		System.out.println(information34);
		
		String information35 = String.format("%35s  %.15s %s", "Surface Temperature:", new BigDecimal(0), "(¡ÆC)");
		...
		String information42 = String.format("%35s  %.15s %s", "Out Radiation Heat Rate:", new BigDecimal(0), "(W)");
		System.out.println(information42);
		
		String information43 = String.format("%35s  %.15s %s", "Convection Heat Rate:", new BigDecimal(0), "(W)");
