...
public class TemperatureAerogel6
{
	...
	{				
		...
		String information15 = String.format("%35s  %.15s %s", "Altitude:", new BigDecimal(altitude+0.01), "(¡Æ)");
		...
		String information33 = String.format("%35s  %.15s %s", "Ambient Temperature:", new BigDecimal(ambient_temperature - 273.19), "(¡ÆC)");
